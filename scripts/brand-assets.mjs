...
const badge=(x,y)=>`<rect x="${x}" y="${y}" width="124" height="30" rx="15" fill="#202630" stroke="${colors.line}"/>${text(x+18,y+20,12,'BETA 0.6.3',colors.muted,700)}`;
...
const promo=svg(440,280,
  ...
  text(24,256,12,'BETA 0.6.3',colors.muted,700)+phone(326,64,88)+
...
console.log('Built beta 0.6.3 GitHub/Gumroad covers, thumbnail, shared arrow icons and labelled store illustrations.');
